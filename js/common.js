...
function comm() {
	...
	btn_show.bind('click', function() {
		var text_1 = '–ö–æ–º–º–µ–Ω—Ç–∞—Ä–∏–π —Å–≤–µ—Ä–Ω—É—Ç. <span>–ü–æ–∫–∞–∑–∞—Ç—å</span>';
		var text_2 = '<span>–°–≤–µ—Ä–Ω—É—Ç—å</span>';
...
$('.datepicker-out').hover( 
	function () {   
		...
		$('.datepicker').datepicker({
			inline: true,
			monthNames: ['ˇÌ‚‡¸','ÙÂ‚‡Î¸','Ï‡Ú','‡ÔÂÎ¸','Ï‡È','Ë˛Ì¸',
			'Ë˛Î¸','‡‚„ÛÒÚ','ÒÂÌÚˇ·¸','ÓÍÚˇ·¸','ÌÓˇ·¸','‰ÂÍ‡·¸'],
			monthNamesShort: ['ˇÌ‚‡ˇ','ÙÂ‚‡Îˇ','Ï‡Ú‡','‡ÔÂÎˇ','Ï‡ˇ','Ë˛Ìˇ',
			'Ë˛Îˇ','‡‚„ÛÒÚ‡','ÒÂÌÚˇ·ˇ','ÓÍÚˇ·ˇ','ÌÓˇ·ˇ','‰ÂÍ‡·ˇ'],
			dayNames: ['‚ÓÒÍÂÒÂÌ¸Â','ÔÓÌÂ‰ÂÎ¸ÌËÍ','‚ÚÓÌËÍ','ÒÂ‰‡','˜ÂÚ‚Â„','ÔˇÚÌËˆ‡','ÒÛ··ÓÚ‡'],
			dayNamesShort: ['‚ÒÍ','ÔÌ‰','‚Ú','Ò‰','˜Ú‚','ÔÚÌ','Ò·Ú'],
			dayNamesMin: ['¬Ò','œÌ','¬Ú','—','◊Ú','œÚ','—·'],
			weekHeader: 'ÕÂ',
			dateFormat: 'd M, yy',
			firstDay: 1,
			onSelect: function(){ 
...
// –ü–æ–¥–≥—Ä—É–∑–∫–∞ –¥–æ–ø–æ–ª–Ω–∏—Ç–ª—å–Ω–æ–π –ø–æ—Ä—Ü–∏–∏ –Ω–æ–≤–æ—Å—Ç–µ–π –≤ –ª–µ–Ω—Ç—É
function loadMoreNews(newsGroup, lastNewsTime) {

	// –ï—Å–ª–∏ –µ—â—ë –Ω–µ –ø–æ–¥–≥—Ä—É–∂–∞–ª–∏ –Ω–æ–≤–æ—Å—Ç–∏, —Ç–æ —Å–æ—Ö—Ä–∞–Ω—è–µ–º —Ç–∞–π–º—à—Ç–∞–º–ø –ø–æ—Å–ª–µ–¥–Ω–µ–π –Ω–æ–≤–æ—Å—Ç–∏ –≤ —Ç–µ–∫—É—â–µ–π –≥—Ä—É–ø–ø–µ newsGroup,
	...
	$.getJSON("/main_page/get_more_news?ajax_no_auth=1&last_news_time=" + groupsLastNewsTime[newsGroup] + "&news_group=" + newsGroup + "&portion=" + (newsGroupsPortionsLoaded[newsGroup] + 1), function(news) {
		...
		// –í—Å—Ç–∞–≤–ª—è–µ–º HTML –ø–æ—Å–ª–µ –ø–æ—Å–ª–µ–¥–Ω–µ–≥–æ —ç–ª–µ–º–µ–Ω—Ç–∞ –≤ –ª–µ–Ω—Ç–µ
...
// –£–¥–∞–ª—è–µ—Ç –±–ª–æ–∫ —Å–æ —Å—Å—ã–ª–∫–æ–π "–ø–æ–∫–∞–∑–∞—Ç—å –µ—â—ë" –≤ –∑–∞–¥–∞–Ω–Ω–æ–π –Ω–æ–≤–æ—Å—Ç–Ω–æ–π –≥—Ä—É–ø–ø–µ
